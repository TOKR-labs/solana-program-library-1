...
pub fn process_instruction(
    ...
    match instruction {
        ...
        LendingInstruction::InitNFTReserve { config } => {
            msg!("Instruction: Init NFT Reserve");
            process_init_nft_reserve(program_id, config, accounts)
        }
